  ...
  document.getElementById("idSearchBtn").addEventListener("click", ()=>{
    ...
    if(searchId.value.trim().length == 0){
      ...
      $.ajax({
        ...
        // 대소문자 주의 (dataType) !!
        // dataType 속성 : 응답 데이터의 타입을 지정하는 속성
        ...
        success : function(member){
          ...
          if(member == null){ // 조회 결과가 없는 경우
            ...
            // const text = document.createTextNode(inputId + " 이라는 회원이 존재하지 않습니다.");
  
            td.innerText = searchId.value + " 이라는 회원이 존재하지 않습니다.";
